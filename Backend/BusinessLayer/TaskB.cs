...
namespace IntroSE.Kanban.Backend.BussinessLayer
{
    public class TaskB
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                TaskB tas = (TaskB)obj;
                if (tas.Email==this.Email & tas.Id == this.Id & tas.Title == this.Title & tas.Description == this.Description & -1 < (tas.CreationTime - this.CreationTime).TotalMinutes && (tas.CreationTime - this.CreationTime).TotalMinutes < 1 & tas.boardMail == this.BoardMail & tas.DueDate == this.DueDate)
