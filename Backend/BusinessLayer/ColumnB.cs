...
namespace IntroSE.Kanban.Backend.BussinessLayer
{
    public class ColumnB
    {
        ...
        private ColumnDalController cont ;
        ...
        //for tests
        public ColumnB(string columnName, int place, int limit, int TaskCounter, Dictionary<int, TaskB> dic, ColumnDalController dalc, TaskDalController dalt)
        {
            this.name = columnName;
            this.id = place;
            this.limit = limit;
        ...
        public virtual TaskB getTask(int taskId)
        {
                return tasks[taskId];
