        ...
        public bool Insert(ColumnDTO column)
        {
            ...
            using (var connection = new SQLiteConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    command.CommandText = $"INSERT INTO {"Column"} ({"Email"},{"Name"},{"ColumnOrdinal"},{"Limit"},{"TaskCounter"})" +
                        $"VALUES (@emailVal,@nameVal,@columnOrdinalVal,@limitVal,@taskCounterVal);";
                    ...
                    SQLiteParameter placeParam = new SQLiteParameter(@"columnOrdinalVal", column.Id);
                    SQLiteParameter limParam = new SQLiteParameter(@"limitVal", column.Limit);
